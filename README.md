...
Dashboard for Slug-A-Bug Pest Control — jobs, leads, quotes, and revenue.

## AI agents

This repo carries a standing roster of custom AI agents that load in every
Claude Code session opened on it:
